...
src="${SCRIPT_DIR}/server/*" # Files to upload
path=/root/Fedukov/lab4.1 # Path to lab folder on server
startCommand="go mod init fedukov_lab4.1; go mod tidy; killall fedukov_lab4.1; go run ." # Launch command 
NetworkList=("yss4") # List of ssh hosts (supposed to use ssh key)

...
src=($SCRIPT_DIR/download.go $SCRIPT_DIR/main.go $SCRIPT_DIR/parse.go $SCRIPT_DIR/server.go $SCRIPT_DIR/start.sh) # Files to upload
path=/root/Fedukov/lab4 # Path to lab folder on server

...
src=("$SCRIPT_DIR/main3.go") # Files to upload
path=/root/Fedukov/lab6 # Path to lab folder on server
startCommand="go mod init main; go mod tidy; go run main3.go" # Launch command 

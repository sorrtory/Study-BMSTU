...
src=("$SCRIPT_DIR/main/" "$SCRIPT_DIR/start.sh") # Files to upload
path=/root/Fedukov/lab5 # Path to lab folder on server
startCommand="./start.sh" # Launch command 
NetworkList=("yss3") # List of ssh hosts (supposed to use ssh key)

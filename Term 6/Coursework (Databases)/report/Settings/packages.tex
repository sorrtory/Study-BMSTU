...
\usepackage{fontspec} % пакет для настройки шрифтов

\usepackage{tabularx} % пакет для создания таблиц с автоматической шириной столбцов

% пакет для управления картинками чтобы не было так, что картинка из раздела 1.2 оказалась в разделе 1.3
% \usepackage[section]{placeins} % автоматически вставляет \FloatBarrier в конце каждого \section
\usepackage{placeins}
